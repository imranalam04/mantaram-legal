            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-white/80">
                  Office/ Shop No. 205 (Including Office / Shop No. 203), Virat Complex (Birat Complex)
                  <br />
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-white/80">+91 9472697743</span>
              </li>
              <li className="flex items-center gap-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="text-white/80">advmlaphc@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
